...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-[90vh] flex flex-col items-center justify-center py-12 px-4 relative">
      ...
      <div className="responsive-grid-3" style={{ maxWidth: "64rem", width: "100%", marginTop: "5rem", zIndex: 10 }}>
        <div className="glass-card p-6 border border-white/5 hover:border-neon-cyan/30 transition-all duration-300 group">
          <div className="w-12 h-12 rounded-xl bg-neon-cyan/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
        ...
        <div className="glass-card p-6 border border-white/5 hover:border-neon-indigo/30 transition-all duration-300 group">
          <div className="w-12 h-12 rounded-xl bg-neon-indigo/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            <Map className="w-6 h-6 text-neon-indigo" />
          </div>
          <h3 className="text-lg font-bold mb-2">Interactive Roadmaps</h3>
          <p className="text-gray-400 text-sm">
            Generate custom, weekly milestone learning roadmaps that adapt based on your timeline and target study hours.
          </p>
        </div>

        <div className="glass-card p-6 border border-white/5 hover:border-neon-purple/30 transition-all duration-300 group">
          ...
          <h3 className="text-lg font-bold mb-2">ATS Resume Analyzer</h3>
          <p className="text-gray-400 text-sm">
